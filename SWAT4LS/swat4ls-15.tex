...
% a short form should be given in case it is too long for the running
% head
\titlerunning{COPO - Linked Open Infrastructure for Plant Data}
...
\authorrunning{Lecture Notes in Computer Science: Authors'
  Instructions}
% (feature abused for this document to repeat the title also on left
% hand pages)
...
% corresponding authors can be found in the file "llncs.dem" (search
% for the string "\mainmatter" where a contribution starts).
